...
class QLearningAgent:
    def __init__(self, action_space, state_space, learning_rate=0.1, gamma=0.99, epsilon=0.1):
        ...
        self.q_table = np.zeros((state_space, action_space))  # Initialisation de la Q-table
    ...
    def update(self, state, action, reward, next_state, done):
        ...
        best_next_action = np.argmax(self.q_table[next_state])  # Action avec la meilleure valeur pour l'état suivant
