...
def test_initial_board(game):
    ...
    assert lines[3] == "[[], [], [], [], [], [], [], [], [], [], [], [], [], []]", "CHEMIN 0 incorrecte."
    assert lines[4] == "[[], [], [], [], [], [], [], [], [], [], [], [], [], []]", "CHEMIN 0 incorrecte."
    assert lines[5] == "[[], [], [], [], [], [], [], [], [], [], [], [], [], []]", "CHEMIN 0 incorrecte."
    assert lines[6] == "[[], [], [], [], [], [], [], [], [], [], [], [], [], []]", "CHEMIN 0 incorrecte."
...
def test_move_pawn_MOVE_OUT(game):
    ...
    assert lines[2] == "chemin vu par joueur 0 : ", "ligne 2 incorrecte."
    assert lines[3] == "[[0], [], [], [], [], [], [], [], [], [], [], [], [], []]", "CHEMIN 0 incorrecte."
    assert lines[4] == "[[], [], [], [], [], [], [], [], [], [], [], [], [], []]", "CHEMIN 0 incorrecte."
    assert lines[5] == "[[1, 1], [], [], [], [], [], [], [], [], [], [], [], [], []]", "CHEMIN 0 incorrecte."
    assert lines[6] == "[[], [], [], [], [], [], [], [], [], [], [], [], [], []]", "CHEMIN 0 incorrecte."
...
def test_get_adversaires_relative_overview(game):
    ...
    assert lines[3] == "[[1, 1], [], [], [], [], [], [], [], [], [], [], [], [], []]", "CHEMIN 0 incorrecte."
    assert lines[4] == "[[], [], [], [], [], [], [], [], [], [], [], [], [], []]", "CHEMIN 0 incorrecte."
    assert lines[5] == "[[0], [], [], [], [], [], [], [], [], [], [], [], [], []]", "CHEMIN 0 incorrecte."
    assert lines[6] == "[[], [], [], [], [], [], [], [], [], [], [], [], [], []]", "CHEMIN 0 incorrecte."
