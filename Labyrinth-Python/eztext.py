        ...
        if event.type == KEYDOWN:
            ...
            if not self.shifted:
                if event.key == K_a and "a" in self.restricted:
                    ...
                    self.value += "z"
                elif event.key == K_KP0 and "0" in self.restricted:
                    self.value += "0"
                elif event.key == K_KP1 and "1" in self.restricted:
                    self.value += "1"
                elif event.key == K_KP2 and "2" in self.restricted:
                    self.value += "2"
                elif event.key == K_KP3 and "3" in self.restricted:
                    self.value += "3"
                elif event.key == K_KP4 and "4" in self.restricted:
                    self.value += "4"
                elif event.key == K_KP5 and "5" in self.restricted:
                    self.value += "5"
                elif event.key == K_KP6 and "6" in self.restricted:
                    self.value += "6"
                elif event.key == K_KP7 and "7" in self.restricted:
                    self.value += "7"
                elif event.key == K_KP8 and "8" in self.restricted:
                    self.value += "8"
                elif event.key == K_KP9 and "9" in self.restricted:
                    self.value += "9"
